...
if __name__=='__main__':
    ...
    #%s)'''
    query='CREATE VIRTUAL TABLE IF NOT EXISTS Documents USING %s(' %FTS_VERSION
    query=query+'%s)'
    columns=[]
    ...
    query='''CREATE VIRTUAL TABLE IF NOT EXISTS DocumentTags USING %s(
    did, tag)''' %FTS_VERSION
    ...
    query='''CREATE VIRTUAL TABLE IF NOT EXISTS DocumentNotes USING %s(
    ...
    query='''CREATE VIRTUAL TABLE IF NOT EXISTS DocumentKeywords USING %s(
    did, text)''' %FTS_VERSION
    ...
    query='''CREATE VIRTUAL TABLE IF NOT EXISTS DocumentContributors USING %s(
    ...
    query='''SELECT * FROM Documents WHERE title MATCH 'ENSO'
    '''
    ret=cout.execute(query)
    print(ret.fetchall())
